...
| Microsoft Purview Data Map *(Phase 2, optional)* | *+~$220/month* |
...
| Purview Data Map *(Phase 2, optional)* | *+~$220* | *+~$220* | *+~$220* |

!!! note "Purview is Phase 2"
    Purview costs are not included in scenario totals above. If enabled in Phase 2, add ~$220/month to any scenario. See [Microsoft Purview](../06_governance/purview.md) for cost breakdown and alternatives.
