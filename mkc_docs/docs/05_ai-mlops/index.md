...
| [Alternative LLM Providers](alternative-llm-providers.md) | APIM multi-backend routing for Anthropic Claude, Google Gemini, and Mistral — Azure AI Foundry (Tier 1) vs. direct APIs (Tier 2), compliance trade-offs, and MKC provider recommendations |
